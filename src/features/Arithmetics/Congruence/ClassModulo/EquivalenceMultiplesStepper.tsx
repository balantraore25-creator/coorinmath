...
export default function EquivalenceMultiplesStepper({ modulo, values, setValues }: ClassModuloProps) {
  ...
  return (
    <Box>
      <Text mb="4">
        Méthode 3 : Ajouter ou retrancher des multiples de n jusqu’à obtenir un représentant dans [0, n-1].
      </Text>
      <Code p="2" display="block" mb="4">
        Trouver k tel que a - k·n ∈ [0, n-1]
      </Code>
      {values.map((item, i) => (
