...
const STORAGE_KEY = "fermat_stepper_v3"

export default function FermatStepper() {
  ...
  useEffect(() => {
    const newPersist: Persisted = { a, p, n, pPrime, step }
      ...
      <Card.Root size="lg" variant="elevated">
        <Card.Header>
          <HStack justify="space-between" w="100%">
            <Heading size="md">Petit Théorème de Fermat — Mode élève</Heading>
            <HStack w="40%">
        ...
        <Card.Body>
          ...
          {step === 1 && (
            <Stack gap={4}>
              <Text>
                Comme n est premier, on peut réduire l’exposant : p′ = p mod (n − 1)
              </Text>
              <HStack>
                <Input
                  ...
                  w="200px"
                />
                <Button onClick={validateReduction}>Valider p′</Button>
              </HStack>
              {error && (
          ...
          {step === 2 && finalValue !== undefined && pPrime !== undefined && (
            <Stack gap={6}>
              <Alert.Root status="success" variant="subtle">
                ...
                <Alert.Content>
                  ...
                  <Alert.Description>
                    Par Fermat, a^{p} mod {n} = {finalValue}
                  </Alert.Description>
                </Alert.Content>
              </Alert.Root>
              ...
              <ModularCircleVisualizer
                ...
                label={`a^${pPrime} ≡ ${finalValue} mod ${n}`}
              />
